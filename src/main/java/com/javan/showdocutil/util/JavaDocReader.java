...
class JavaDocReader {
   ...
   private static void addRequestReturn(MethodDoc method) throws Exception {
       ...
       if (!BaseTypeUtil.isBaseType(typeName)) {
           ...
           doParseType(new Type[]{type}, builder, "", true);
       }
   ...
   private static String getRequestParamText(Map<String, String> baseCn, Parameter[] parameters) throws Exception {
       ...
       for (Parameter parameter : parameters) {
           ...
           if (!BaseTypeUtil.isBaseType(typeName)) {
               ...
               doParseType(new Type[]{type}, builder, null, true);
           }
       }
   ...
   static void doParseType(Type[] types, StringBuilder builder, String delimit, boolean noappend) throws Exception {
       if (delimit == null) {
           delimit = "";
       }
       for (int i = 0; i < types.length; i++) {
           ...
           if (parameterizedType != null) {
               ...
               // 递归
               doParseType(typesArguments, builder, delimit + PrefixMark.PREFIX, false);
           } else {
               ...
               if (!BaseTypeUtil.isBaseType(type.qualifiedTypeName())) {
                   ...
                   try {
                       // may cycle
                       String modelText = JavaDocTextUtil.getModelText(type.qualifiedTypeName(), newDelimit);
                       builder.append(modelText);
                   } finally {
                       // clear Set
                       clearCycleSet();
                   ...
                   // base type
                   appendSub(builder, type, newDelimit);
               }
           }
       }
   }
   ...
   private static void appendSub(StringBuilder builder, Type ty, String delimit) {
       builder.append("|");
       builder.append(delimit);
   ...
   public static void parse(String typeName) throws Exception {
